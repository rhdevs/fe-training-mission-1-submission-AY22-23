...
const students: Person[] = [bob, steve, mary] // assign an appropriate type to `students`
...
// }
newNumbers = numbers.map((index, num) => index + num)
...
//   product *= numbers[i]
// }
product = numbers.reduce((v1, v2) => v1 * v2)
